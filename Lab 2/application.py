...
mysql=MySQL(app)
app.config['MYSQL_HOST']	 = 'aae4ytox42dbyx.cx7ncna0qmke.us-east-1.rds.amazonaws.com'
app.config['MYSQL_USER']	 = 'sujeeth'
app.config['MYSQL_PASSWORD'] = 'sujeeth123'
app.config['MYSQL_DB'] 		 = 'healthcaresystem'
